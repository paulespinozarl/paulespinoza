  ...
  return (
    <nav className='flex p-5 text-gray-200'>
      ...
      <div className='text-xl font-bold max-w-4xl mx-auto flex items-center mt-2'>
        <a href="https://www.linkedin.com/in/paulespinozarl/" target="_blank" rel="noopener noreferrer" className="transition-transform duration-200 hover:scale-125 mr-5">
