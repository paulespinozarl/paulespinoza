      ...
      <div className='mx-4 my-2'>
        <div className="contenedor">
          <div className="w-2/4 p-2 rounded-2xl m-2">
            ...
            <p className=" text-md lg:text-xl p-3 text-gray-50 lg:w-full max-w-64">Radicado en Argentina con experiencia en el desarrollo de aplicaciones y paginas web usando frameworks y bibliotecas UI.</p>
